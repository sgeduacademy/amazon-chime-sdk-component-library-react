...
const { logger, spawnOrFail, shouldContinuePrompt, process } = require('./utilities.js');
const prompt = require('prompt-sync')();
const path = require('path');
const fs = require('fs');

const currentVersion = require('../package.json').version;
const latestNPMJSSdkVersion = spawnOrFail('npm', [`show amazon-chime-sdk-js version`], { skipOutput: true }).trim();
...
const versionBump = (option, branchName) => {
  if (!option) {
